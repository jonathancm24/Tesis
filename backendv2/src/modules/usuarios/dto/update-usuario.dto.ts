 ...
 * Excluye la contraseña por seguridad (se actualiza por separado)
 */
 ...
 * Se maneja por separado por seguridad
 */
export class ChangePasswordDto {
  @IsString({ message: 'La contraseña actual debe ser una cadena de texto' })
  @MinLength(1, { message: 'Debe proporcionar la contraseña actual' })
